 ...
 * @author Ruben
 */
public class comandoMostrarTurnoParaModificar implements Command{
	...
	if (turno != null) //Si existe
        {
            respuesta = new RespuestaComando(EventoNegocio.EXITO_MOSTRAR_TURNO_PARA_MODIFICAR, datosAlmacenados);
	}
	else
        {
            respuesta = new RespuestaComando(EventoNegocio.FRACASO_MOSTRAR_TURNO_PARA_MODIFICAR, datosAlmacenados);
	}
	return respuesta;
